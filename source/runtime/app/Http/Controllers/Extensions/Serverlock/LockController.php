...
class LockController extends Controller
{
    ...
    {
        $server = Server::where(function ($query) use ($identifier) {
            $query->where('uuidShort', $identifier)
